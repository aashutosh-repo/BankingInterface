...
import { PaymentProcesingComponent } from '../features/payments/components/payment-procesing/payment-procesing.component';
...
export const paymentRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'v1/digital', component: PaymentProcesingComponent },
