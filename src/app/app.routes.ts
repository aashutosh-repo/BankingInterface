...
import { CustomerSearchDialogComponent } from './pages/customer/shared/customer-search-dialog/customer-search-dialog.component';
...
export const routes: Routes = [
    ...
    {path: 'customer-search', component: CustomerSearchDialogComponent},
